...
# archs
load("/Users/msun/Documents/covid19_gender/code/final_plot/id_tissue_prediction_final.RData")
load("/Users/msun/Documents/covid19_gender/code/final_plot/id_gender_prediction_final.RData")
load("/Users/msun/Documents/covid19_gender/code/final_plot/id_age_prediction_final.RData")

id_gender_prediction$id=as.character(id_gender_prediction$id)
id_tissue_prediction$id=as.character(id_tissue_prediction$id)
id_gender_prediction$gender = as.numeric(as.character(id_gender_prediction$gender))
id_tissue_prediction$tissue = as.numeric(as.character(id_tissue_prediction$tissue))

tmp = order(data_archs$id)
id_age_prediction = data_archs[tmp,]

tmp = order(id_gender_prediction$id)
id_gender_prediction = id_gender_prediction[tmp, ]

tmp = order(id_tissue_prediction$id)
id_tissue_prediction = id_tissue_prediction[tmp, ]

all.equal(id_age_prediction$id, id_gender_prediction$id)
all.equal(id_tissue_prediction$id, id_gender_prediction$id)
id = id_age_prediction$id

id_gender_age_tissue = cbind(id, id_gender_prediction$pred, id_age_prediction$pred, id_tissue_prediction$pred)
colnames(id_gender_age_tissue)=c('id', 'gender', 'age', 'tissue')
sum(is.na(id_gender_age_tissue))
