...
library(pheatmap)
pheatmap(t(-log(tissue_ESR1_AR, 10)), cellheight = 10, cellwidth = 10, show_colnames=T, legend=T, show_rownames=T, cluster_cols=F, cluster_rows = F, filename = "figure/ACE2_ESR1_AR.pdf") #, filename = "ritonavir_dz_cor_dose.pdf, filename = "ritonavir_selected_dz_cor.pdf"
