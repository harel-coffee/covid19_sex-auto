...
parser.add_argument('--dataset', type=str, default='GPL570')
...
# load dataset
train_dataset = Gene(root='../output/LABELS/', dataset=dataset, fold=fold, train=True)
num_iter_per_epoch = int(len(train_dataset.train_labels1)/batch_size)
print('num_iter_per_epoch {:d}'.format(num_iter_per_epoch))
test_dataset = Gene(root='../output/LABELS/', dataset=dataset, fold=fold, train=False)
...
save_dir = '../output/LABELS/' + dataset + '_task_2/'
