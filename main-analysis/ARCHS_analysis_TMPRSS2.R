...
if (gpl=='all'){
    ...
    expr_meta = expr_meta[!is.na(expr_meta$gender) & expr_meta$TMPRSS2 > 0.5  & expr_meta$gpl==gpl, ] # 'GPL16791' , 'GPL11154', 'GPL18573'
}
...
pdf(paste("figure/ARCHS", gpl, "TMPRSS2_gender.pdf", sep="_"))
# par(mar = c(14, 4, 4, 2) + 0.1, las=2)
beanplot(TMPRSS2   ~ two_group, data = expr_meta_subset, ll = 0.15, log = "",
         main = "", ylab = "TMPRSS2 Expression", side = "both", ylim=c(-1,16),what = c(T, T, T, F),
...
pdf(paste("figure/ARCH5", gpl, "TMPRSS2_ages.pdf", sep="_"), width=10)
# par(mar = c(14, 4, 4, 2) + 0.1, las=2)
beanplot((TMPRSS2)  ~ two_group, data = expr_meta_subset, ll = 0.15, log = "",
...
#pdf(paste("figure/ARCHS_TMPRSS2_", symbols[i], gender, ".pdf", sep="_"))
...
if (gpl == 'GPL11154'){
  main_tissues = c("blood", "brain",  "breast", "colon", "heart", "intestine", "kidney",  "liver", "lung", "pancrea",  "skin") # "bone", "prostate"， "testis", "prostate", not enough
}
if (gpl == 'GPL18573'){
  main_tissues = c("blood", "brain", "breast", "colon", "heart", "kidney",  "liver",  "lung", "pancrea", "skin" ) # "bone", "prostate", "intestine", "testis", not enough
}
if (gpl=='GPL16791'){
  main_tissues = c("blood", "brain", "breast", "colon", "heart", "intestine", "kidney", "liver", "lung", "pancrea",  "skin","testis") # "bone", "prostate" not enough
}
...
#                                       levels=c("blood 1", "blood 2", "brain 1", "brain 2",   "breast 1", "breast 2",
...
#                                                "colon 1", "colon 2", "heart 1", "heart 2", "intestine 1", "intestine 2", 
#                                                "kidney 1", "kidney 2",  "liver 1", "liver 2", "lung 1", "lung 2",
#                                                "pancrea 1",  "pancrea 2", "skin 1", "skin 2", "testis 1", "testis 2"))
#   
# }
# 
# if (gpl=='all'){
...
pdf(paste("figure/ARCHS", gpl, "TMPRSS2_tissue_20.pdf", sep="_"), width = 30)
# par(mar = c(14, 4, 4, 2) + 0.1, las=2)
beanplot((TMPRSS2  )  ~ two_group, data = expr_meta_subset, ll = 0.15, log = "",
         main = "", ylab = "TMPRSS2 Expression", side = "both", ylim=c(-1,15), what = c(T, T, T, F),
         border = NA, col = list(c("blue","blue"), c("red", "red")), 
...
#####################
#investigate highly expressed TMPRSS2
###
#airway
